package com.pnwrain.flashsocket
{
	...
	public class FlashSocket implements IWebSocketLogger, IEventDispatcher
	{
		...
		protected var logger:IWebSocketLogger;
		...
		public function FlashSocket(domain:String, logger:IWebSocketLogger, protocol:String = null, proxyHost:String = null, proxyPort:int = 0, headers:String = null)
		{
		...
		private function _onMessage(message:String):void
		{
			 ...
			 * https://github.com/Automattic/socket.io-client/blob/master/socket.io.js#L3460
			   ...
			   , noop:     6
			 */
			log("3:message received:'" + message+"'");
			if (message == "3")
			{
